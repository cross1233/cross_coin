...
exports.CROSS_CHAIN_MODULE_ADDRESS = exports.APTOS_TESTNET_CONFIG = exports.aptosCCTPReceiver = exports.AptosCCTPReceiver = void 0;
...
exports.APTOS_TESTNET_CONFIG = APTOS_TESTNET_CONFIG;
// 我们部署的跨链合约地址
const CROSS_CHAIN_MODULE_ADDRESS = "0xba916e9cbf294e552e4281dfc227fadbd3413d81c2fc233816f85dd89d53f54c";
exports.CROSS_CHAIN_MODULE_ADDRESS = CROSS_CHAIN_MODULE_ADDRESS;
/**
 * Aptos CCTP接收器类
 * 负责在Aptos链上接收并铸造从Base链发送的USDC
 */
class AptosCCTPReceiver {
    constructor() {
        // 初始化Aptos客户端
     ...
     * 验证消息字节格式
     */
    validateMessageBytes(messageBytes) {
        // 基本验证：应该是十六进制字符串
    ...
    async receiveCCTPUSDC(params) {
        try {
            ...
            const privateKey = new ts_sdk_1.Ed25519PrivateKey(params.recipientPrivateKey);
     ...
     */
    async buildReceiveCCTPTransaction(params) {
        try {
            ...
            // 构建交易（不签名）
            const transaction = await this.aptos.transaction.build.simple({
                sender: ts_sdk_1.AccountAddress.fromString(params.senderAddress),
                data: {
                    function: `${CROSS_CHAIN_MODULE_ADDRESS}::cctp_receiver::receive_cctp_usdc`,
                    functionArguments: [
                        messageBytesArray,
     ...
     * 查询CCTP接收事件
     */
    async getCCTPReceiveEvents(address, limit = 10) {
        try {
     ...
     * 检查消息是否已经被处理过
     */
    async isMessageProcessed(messageHash) {
        try {
...
exports.AptosCCTPReceiver = AptosCCTPReceiver;
// 导出单例实例
exports.aptosCCTPReceiver = new AptosCCTPReceiver();
//# sourceMappingURL=aptos-receiver.js.map