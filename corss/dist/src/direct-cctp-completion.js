...
exports.completeWithPrecompiledScript = completeWithPrecompiledScript;
 ...
 */
async function completeWithPrecompiledScript() {
    try {
        ...
        const transaction = await aptos.transaction.build.simple({
            ...
            data: {
                ...
                functionArguments: [
                    ts_sdk_1.MoveVector.U8(messageBytesArray),
                    ts_sdk_1.MoveVector.U8(attestationArray)
                ],
            },
        });
        console.log('📤 签名并提交交易...');
...
//# sourceMappingURL=direct-cctp-completion.js.map